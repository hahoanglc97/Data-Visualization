...
links = []
links.append(crawl_util.load_links(crawl_util.SHOPEE_URL + 'search?keyword=', keywords))
links.append(crawl_util.load_links(crawl_util.SHOPEE_URL + 'mall/search?keyword=', keywords))
