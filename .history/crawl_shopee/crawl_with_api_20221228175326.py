...
conn = http.client.HTTPSConnection("shopee.vn")
payload = ''
headers = {
  'af-ac-enc-dat': '',
...
conn.request("GET", "/api/v4/search/search_items?by=relevancy&keyword=quan%2520ao%2520nu&limit=60&newest=0&order=desc&page_type=search&scenario=PAGE_GLOBAL_SEARCH&version=2&view_session_id=098aa3e6-8c83-44dd-9012-470b7f0c7c61", payload, headers)
